...
def generate_translation_prompt(previous_translation, current_chunk, glossary_text):    
    return f"""
            ...
            The text is from the Japanese Light Novel 'Danmachi', so use your knowledge of the series to smoothen out the translation. 
...
def process_file(input_file, output_file, glossary_file="glossary.json", tokens_per_chunk=1000, overlap_tokens=50, max_retries=3, model="gemini-2.0-flash-thinking-exp-01-21"):
